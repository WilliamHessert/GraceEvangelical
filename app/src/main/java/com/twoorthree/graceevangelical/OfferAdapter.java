...
public class OfferAdapter extends BaseAdapter {
    ...
    Context context;
    ArrayList<OfferItem> items;
    private static LayoutInflater inflater = null;

    public OfferAdapter(Context context, ArrayList<OfferItem> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(item.getDesc().length()>35) {
            stat = item.getDesc().substring(0, 35) + "...";
        }
        else { stat = item.getDesc(); }
